...
//        btn_back = findViewById(R.id.btn_back_murree);
        btn_weather = findViewById(R.id.btn_weather_murree);

        hotel1 = findViewById(R.id.hotel1_layout_murree);
...
//                Intent intent = new Intent(MurreeActivity.this, HomeFragment.class);
...
//        });
        ...
        hotel1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MurreeActivity.this, Hotel4Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_weather.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MurreeActivity.this, WeatherUpdateActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        db.collection("hotel").document("7Pyb86UeV5wQ8vRFjfgv").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                Glide.with(getApplicationContext()).load(documentSnapshot.getString("hotel_4")).into(imageView1);
