...
public class MelaChiraghanActivity extends AppCompatActivity {
...
//    private Button btn_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mela_chiraghan);

//        btn_back = findViewById(R.id.btn_back_mela);

        restaurant1 = findViewById(R.id.restaurant1_layout_mela);
        ...
        zeeshan = findViewById(R.id.zeeshan_layout_mela);
...
//               Intent intent = new Intent(MelaChiraghanActivity.this, HomeFragment.class);
...
//       });
        ...
        restaurant1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MelaChiraghanActivity.this, Restaurant1Activity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        zeeshan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MelaChiraghanActivity.this, Transporter2Activity.class);
                startActivity(intent);
                finish();
            }
        });
