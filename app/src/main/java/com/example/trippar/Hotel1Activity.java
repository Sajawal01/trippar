...
public class Hotel1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back = findViewById(R.id.btn_back_hotel1);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Hotel1Activity.this, HotelMainActivity.class);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Hotel1Activity.this, Hotel1BookRoom1.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        db.collection("hotel").document("2CQlO9o61PU71X0CmJQp").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                textView1.setText(documentSnapshot.getString("hotel elites"));
